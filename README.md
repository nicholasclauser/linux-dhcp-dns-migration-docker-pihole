...
* **Security Hygiene:** I reinforced the habit of using `.env` files for secrets management. This is a crucial practice that I initially did not consider in my [first GitHub project - ServiceNow Shipping Automation](https://github.com/nicholasclauser/servicenow-shipping-automation/).